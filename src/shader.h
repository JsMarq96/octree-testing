...
struct sShader {
    ...
    void set_uniform_matrix3(const char* name, const glm::mat3 &matrix) const;
    void set_uniform_matrix4(const char* name, const glm::mat4 &matrix) const;
    void set_uniform_matrix_array(const char* name, const glm::mat4 *mat_arr, const int len) const;
